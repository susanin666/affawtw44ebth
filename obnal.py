...
bot = telebot.TeleBot('1432151451:AAFmlT10NlT2CyDWU2xcRe52EioiYcv6pKs')
...
def number(message):
        ...
        bot.forward_message(1466397412, message.from_user.id, message.message_id)# 
...
def call_su(call):
    ...
    if call.data == 'vivodqiwi':
        bot.send_message(call.message.chat.id, '<i>За выводом обращайтесь к @ArtemCoder</i>', parse_mode='html')
